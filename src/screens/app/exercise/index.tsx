                    ...
                    <View className="bg-gray-700 border border-gray-600 p-4 rounded-lg">
                        <View className="flex-row items-center justify-center gap-6 mb-6">
                            <View className="flex-row gap-1 items-center">
                                <SeriesSvg width={24} height={24} fill="#EAB308" />
                                <Text className="text-white text-lg"> 3 Séries </Text>
                            </View>

                            <View className="flex-row gap-1 items-center">
                                <RepetitionsSvg width={24} height={24} fill="#EAB308" />
                                <Text className="text-white text-lg"> 12 repetições </Text>
                            </View>
                        </View>
