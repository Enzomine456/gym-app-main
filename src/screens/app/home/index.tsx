        ...
        <View className="flex-1">
            ...
            <View className="flex-1 px-8">
                <View className="flex-row items-center justify-between mb-8">
                    <Text className="text-yellow-500 font-bold text-xl"> Exercícios </Text>

                    <View className="size-6 bg-yellow-500 rounded items-center justify-center">
                        <Text className="text-white text-base"> {exercises ? exercises.length : 0} </Text>
                    </View>
                </View>
